...
class iceoryxProxyClass : public ara::com::proxy::ServiceProxy<iceoryxProxyClass>
{


public:
    ara::core::Result<ServiceHandleContainer<ProxyHandleType>> FindServiceImpl(ara::com::network_binding::iceoryx::InstanceIdentifier identifier)
    {
        // 检查identifier可用性
        if (identifier.empty()) {
            return ara::core::Result<ServiceHandleContainer<ProxyHandleType>>::FromError(ara::com::MakeErrorCode(ara::com::ComErrc::kInvalidInstanceIdentifierString, 0));
        }
        return ara::com::network_binding::iceoryx::Runtime::GetInstance().FindService(identifier);
    }
};
